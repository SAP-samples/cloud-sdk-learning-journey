					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Business Partners - User Interface",
									"targetURL": "#comsapbpui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapbpui-display": {
								"semanticObject": "comsapbpui",
								"action": "display",
								"description": "Business Partners - User Interface",
								"title": "Business Partners - User Interface",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.bpui",
									"url": sap.ui.require.toUrl("com/sap/bpui")
								}
							}
						}
					}
