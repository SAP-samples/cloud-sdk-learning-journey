    ...
    return BaseController.extend('sap.ui.demo.addressmgr.controller.Detail', {
      ...
      onInit: function () {
        ...
        this.getRouter()
          ...
          .attachPatternMatched(this._onBusinessPartnerMatched, this);
      },
      ...
      onSubmitEditAddress: function () {
        ...
        if (oModel.getProperty('/isNew')) {
          ...
          action = businessPartnerService.updateAddress(
            oModel.getProperty('/businessPartner'),
            oModel.getProperty('/addressId'),
            oModel.getData(),
          );
        }
      ...
      onDeleteAddress: function (oEvent) {
        ...
        var sPath = oEvent
          .getSource()
          .getBindingContext(this.mainModelName)
          .getPath();
        var oViewModel = this.getViewModel();
        ...
        businessPartnerService
          .deleteAddress(
            oModel.getProperty(sPath + '/businessPartner'),
            oModel.getProperty(sPath + '/addressId'),
          )
          .always(function () {
            oViewModel.setProperty('/busy', false);
            that._reloadDetailsModel();
      ...
      openEditDialog: function (addressData) {
        if (!this.editAddressDialog) {
          this.editAddressDialog = sap.ui.xmlfragment(
            'sap.ui.demo.addressmgr.view.EditAddress',
            this,
          );
        ...
        this.editAddressDialog
          ...
          .setData(
            address.create(
              addressData,
              this.getMainModel().getProperty('/businessPartner'),
            ),
          );
      ...
      _onBusinessPartnerMatched: function (oEvent) {
        var sBusinessPartnerId =
          oEvent.getParameters().arguments.businessPartnerId;
      ...
      _loadDetailsModel: function (sBusinessPartnerId) {
        ...
        oModel.attachRequestFailed(function () {
          that
            .getRouter()
            .getTargets()
            .display('detailMessagePage', {
              messageType: MessageType.NOTHING_FOUND,
            });
        });

        oModel.loadData(
          businessPartnerService.getBusinessPartnerUrl(sBusinessPartnerId),
        );
      },
