  ...
  function (
    ...
    return BaseController.extend('sap.ui.demo.addressmgr.controller.Master', {
      ...
      onInit: function () {
        ...
        this.getRouter()
          .getTargets()
          .getTarget('detailMessagePage')
          .attachDisplay(function () {
      ...
      _onMasterMatched: function () {
        this.getRouter()
          ...
          .display('detailMessagePage', {
            messageType: MessageType.NOTHING_SELECTED,
          });
      },
      ...
      _onBusinessPartnerMatched: function (oEvent) {
        ...
        that
          .getModel('masterView')
          .setProperty('/selectedBusinessPartner', sBusinessPartnerId);
      },
